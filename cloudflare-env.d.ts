/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: d7a30d8e344e551a2dc1451730ffd8ba)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_ASSISTANT_BASE_URL: string;
