...
import { SlotMachine } from "@/components/assistant-ui/slot-machine";
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col items-center justify-start pt-8 pb-24">
      {/* Vegas-themed Slot Machine */}
      <SlotMachine />
    </div>
  );
};
